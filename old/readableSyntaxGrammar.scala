object ReadableSyntaxGrammar {
  ...
  val rules = (List(
    ...
    GrammarRule(begin       , List(t_optNewLines, t_begin, commentNL, declarations, commentNL, doc, commentNL, t_end, begin  ), 0),
    GrammarRule(begin       , List(t_optNewLines, t_begin, commentNL, declarations, commentNL, doc, commentNL, t_end, commentNL     ), 0),
